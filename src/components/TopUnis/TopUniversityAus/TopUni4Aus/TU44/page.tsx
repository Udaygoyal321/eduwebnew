...
=======
  ...
  { id: 2, label: <>Faculty of Business</> },
  { id: 3, label: <>Faculty of Science</> },
  { id: 4, label: <>Faculty of Arts, Design &<br/> Architecture</> },
  { id: 5, label: <>Faculty of Medicine & <br/>Health Sciences</> },
>>>>>>> 54e5b2b (Initial commit)
];

export default function TU44() {
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          AUD ~$61,000/year (2025 estimate)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          High School (Maths/Physics) + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Global Media Communication</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 Years (Full-Time)
                        </div>
                  ...
                  {id === 5 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          AUD ~$49,200/year (approx) UNSW Sites
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
