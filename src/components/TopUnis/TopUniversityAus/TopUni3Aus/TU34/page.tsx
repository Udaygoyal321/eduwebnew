...
const ITEMS: Item[] = [
<<<<<<< HEAD
  { id: 1, label: <>Faculty Of Business & <br /> Economics</> },
  { id: 2, label: <>Faculty Of Medicine & <br /> Health Science</> },
  { id: 3, label: <>Faculty Of Arts &  Social <br />Science</> },
  { id: 4, label: <>Faculty Of Engineering & <br /> IT</> },
  { id: 5, label: <>Faculty Of Science & <br /> Environment</> },
=======
  { id: 1, label: <>Faculty of Arts & Social<br/> Sciencess</> },
  { id: 2, label: <>Faculty of Engineering &<br/> IT</> },
  { id: 3, label: <>Faculty of Medicine & <br/>Health Sciences</> },
  { id: 4, label: <>Faculty of Business</> },
  { id: 5, label: <>Faculty of Science</> },
>>>>>>> 54e5b2b (Initial commit)
];

export default function TU34() {
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          AUD $49,200/Year (approx) The University of Sydney+1
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Class 12 (or equivalent) + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                  ...
                  {id === 2 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          AUD $60,600/Year (guide for 2026) The University of Sydney
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Data Science</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 Years (Full-Time)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          AUD $57,900/Year (guide for 2026) The University of Sydney
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in IT/Maths/Science + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February & July
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          AUD $49,200/Year (approx) The University of Sydney
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          AUD $61,700/Year (guide for 2026) The University of Sydney
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                  ...
                  {id === 4 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          AUD $56,300/Year (guide for 2026) The University of Sydney
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Class 12 + IELTS 6.5
                        </div>
                  ...
                  {id === 5 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          AUD $56,300/Year (approx) The University of Sydney
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
