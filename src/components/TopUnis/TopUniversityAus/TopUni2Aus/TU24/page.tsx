...
=======
  { id: 2, label: <>Faculty Of Medicine, Dentistry & <br /> Health Science</> },
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Class 12 (Maths preferred) + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Master of Management (Accounting / Finance / Marketing)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 Years (Full-Time)
                  ...
                  {id === 2 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Class 12 (Biology/Chemistry) + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Public Health</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 Years (Full-Time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s degree (Health/Science) + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February & July
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Doctor of Medicine (MD)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          4 years (full-time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in Science/Health + GAMSAT + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Intake: February
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in Arts/Media + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Software Engineering</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 Years (Full-Time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in IT/CS/Engineering + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
                  ...
                  {id === 5 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s degree in Science/Environment + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February & July
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in Biology/Chemistry + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
