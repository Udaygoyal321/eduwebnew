      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            UTS, based in Sydney, New South Wales, is recognised as<br/> Australia’s #1 young university with a strong international outlook.<br/> With more than 51,000 students, a central city campus and <br/>advanced facilities, UTS offers practice-based education and high<br/> employability outcomes.
            </p>
          {/* Button */}
