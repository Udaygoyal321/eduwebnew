...
>>>>>>> 54e5b2b (Initial commit)
  ...
  useEffect(() => {
<<<<<<< HEAD
    // Store the original button width (so it stays same when fixed)
...
<<<<<<< HEAD
      // Handle stacking of sticky images
...
<<<<<<< HEAD
        width: buttonWidth ? `${buttonWidth}px` : "auto", // ✅ lock size
=======
