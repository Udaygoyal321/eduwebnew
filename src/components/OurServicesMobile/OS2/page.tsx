                  ...
                  <li key={item.id}>
                    <button
                      ...
                      className={`w-10 h-10 rounded-xl border-none cursor-pointer flex items-center justify-center transition-all duration-200 ${
                        isActive
<<<<<<< HEAD
                          ? "bg-gradient-to-br from-cyan-400 to-cyan-600 text-white scale-105"
=======
                  ...
                  >
                    ...
                    >
                      <div className="p-6 sm:p-8 lg:p-10">
                        ...
                        <div className="pt-4">
<<<<<<< HEAD
                          <button className="bg-cyan-400 text-md text-white px-4 py-2 rounded-full hover:shadow-md hover:bg-cyan-500 transition-shadow duration-300 ease-in-out">
                            See More
                          </button>
                        </div>
=======
