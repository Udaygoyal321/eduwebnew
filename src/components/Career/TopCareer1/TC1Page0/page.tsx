...
export default function TC1Page0 () {
  ...
  return (
    ...
    >
      ...
      {/* ===== content ===== */}
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        <h1
        ...
        >
          <span className="block text-base sm:text-lg">
            Discover Canada’s most in-demand professions and growing industries in Canada. Explore your ideal career path and 
          </span>
          <span className="block text-base sm:text-lg">
            find the right course to get there.
          </span>
        </p>
      ...
      >
        <button className="px-6 py-2.5 -translate-y-2 rounded-full text-white bg-[#37D7D9] font-medium hover:bg-[#00B7C1] hover:shadow-md hover:shadow-gray-400 transition-shadow duration-300 ease-in-out">
          Explore Careers
        </button>
      </div>
    </section>
