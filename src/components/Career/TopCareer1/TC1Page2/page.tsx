...
export default function TC1Page2() {
  return (
    <main className="min-h-screen">
      <div className="mx-auto max-w-screen-xl text-center">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Choose A Career In Australia
        </h1>
         <div className="flex justify-center mt-16">
          <Image
            src="/images/tc1page2Img1.png"
      ...
      <div className="text-center mt-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Average Salary Range in the australia (per year)
        </h1>
         <div className="mt-16">
          <Image
            src="/images/tc1page2Img2.png"
            alt="Why Choose a Career in Australia"
            width={2000}
            height={400}
...
>>>>>>> 54e5b2b (Initial commit)
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          {/* LEFT: Bullet points */}
<<<<<<< HEAD
          <ul className=" w-5xl space-y-6 text-2xl text-[#000000] list-disc list-inside md:ml-28 leading-relaxed">
