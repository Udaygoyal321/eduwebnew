  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="text-center mt-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Average Salary Range in the New Zealand (per year)
        </h1>
         <div className="mt-16">
          <Image
...
<<<<<<< HEAD
          <ul className=" w-5xl space-y-6 text-2xl text-[#000000] list-disc list-inside md:ml-26 leading-relaxed">
            <li>Identify in-demand careers and relevant study programs in<br/> the UK</li>
            <li>Shortlist top universities offering industry-aligned courses</li>
            <li>Assist with applications, scholarships, and visa processes</li>
=======
          <ul className=" w-5xl space-y-6 text-2xl text-[#000000] list-disc md:ml-26 leading-relaxed">
            <li>Identify in-demand careers and relevant study programs in<br/> the UK</li>
            <li>Shortlist top universities offering industry-aligned <br/>courses</li>
            <li>Assist with applications, scholarships, and visa <br/>processes</li>
>>>>>>> 54e5b2b (Initial commit)
            <li>Provide continuous career and placement guidance</li>
          </ul>
