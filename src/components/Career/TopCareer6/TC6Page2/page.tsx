...
<<<<<<< HEAD
          <ul className=" w-5xl space-y-6 text-2xl text-[#000000] list-disc list-inside md:ml-26 leading-relaxed">
            ...
            <li>Shortlist universities and programs that align with U.S. job<br/> market trends</li>
            <li>Assist with applications, scholarships, and visa guidance (F-1,<br/> OPT, H-1B)</li>
=======
