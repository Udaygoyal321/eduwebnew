...
const steps: Step[] = [
  {
    ...
    description:
      "Sign up to connect with students from around the world who are exploring or already studying abroad in your dream destination.",
    side: "right",
  ...
  },
  {
    ...
    description:
      "Chat directly with alumni and mentors who can guide you with practical tips about courses, universities, and career opportunities.",
    side: "left",
  ...
  },
  {
    ...
    description:
      "Post your questions about studying abroad, visas, scholarships, or life in a new country — and get instant answers from real students and experts.",
    side: "right",
    titlePosition: "absolute top-37 left-1/2 ml-12 w-[40%]",
    descriptionPosition: "absolute top-49 left-1/2 ml-12 w-[40%]",
  },
  {
    ...
    description:
      "Participate in discussions, webinars, and community events to expand your network and stay updated on opportunities abroad.",
    side: "left",
    titlePosition: "absolute top-37 right-1/2 mr-12 w-[40%] text-right",
    descriptionPosition: "absolute top-49 right-1/2 mr-12 w-[40%] text-right",
  },
...
export default function Slide3Page1() {
...
=======
  className="absolute left-1/2 top-0 -translate-x-1/2 border-r-3 border-gray-400"
  style={{ height: "1175px" }} // set your desired fixed length
></div>
>>>>>>> 54e5b2b (Initial commit)
        ...
        {floatState === "bottom" && (
<<<<<<< HEAD
          <div className="absolute left-1/2 -translate-x-1/2" style={{ top: tealBottomTop }}>
=======
