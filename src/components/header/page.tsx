    ...
    >
      ...
      >
        ...
        <div className="relative flex flex-row group">
          ...
          <div className="absolute left-0 top-full hidden group-hover:flex flex-col bg-white shadow-lg rounded-lg w-52 py-2 z-50">
            <Link
        ...
        <div className="relative flex flex-row group">
          Top Universities
          <FaChevronDown className="text-[12px] mt-1 ml-1 transition-transform duration-300 group-hover:rotate-180" />
          <div className="absolute left-0 top-full hidden group-hover:flex flex-col bg-white shadow-lg rounded-lg w-60 py-2 z-50">
            <Link
      ...
      {menuOpen && (
        <div className="absolute top-full left-0 w-full bg-white shadow-md flex flex-col items-center space-y-4 py-4 md:hidden">
          ...
          <Link href="/ourservices" onClick={() => setMenuOpen(false)}>
            Services
          </Link>
          <Link href="/topunis" onClick={() => setMenuOpen(false)}>
            Top Universities
          </Link>
          <Link href="/maincareer" onClick={() => setMenuOpen(false)}>
            Careers
          </Link>
